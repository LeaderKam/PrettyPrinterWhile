 ...
 * </p>
 * <ul>
 *   <li>{@link pretty.wh.Expr#getValeur <em>Valeur</em>}</li>
 *   <li>{@link pretty.wh.Expr#getOpe <em>Ope</em>}</li>
 *   <li>{@link pretty.wh.Expr#getLexpr <em>Lexpr</em>}</li>
 *   <li>{@link pretty.wh.Expr#getExpr <em>Expr</em>}</li>
 *   <li>{@link pretty.wh.Expr#getEx1 <em>Ex1</em>}</li>
 *   <li>{@link pretty.wh.Expr#getEx2 <em>Ex2</em>}</li>
 * </ul>
 *
 * @see pretty.wh.WhPackage#getExpr()
 * @model
 * @generated
 */
public interface Expr extends EObject
{
   ...
   * @see pretty.wh.WhPackage#getExpr_Valeur()
   * @model
   * @generated
   */
  String getValeur();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getValeur <em>Valeur</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOpe(String)
   * @see pretty.wh.WhPackage#getExpr_Ope()
   * @model
   * @generated
   */
  String getOpe();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getOpe <em>Ope</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setLexpr(Lexpr)
   * @see pretty.wh.WhPackage#getExpr_Lexpr()
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getLexpr <em>Lexpr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setExpr(Expr)
   * @see pretty.wh.WhPackage#getExpr_Expr()
   * @model containment="true"
   * @generated
   */
  Expr getExpr();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setEx1(Expr)
   * @see pretty.wh.WhPackage#getExpr_Ex1()
   * @model containment="true"
   * @generated
   */
  Expr getEx1();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getEx1 <em>Ex1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setEx2(Expr)
   * @see pretty.wh.WhPackage#getExpr_Ex2()
   * @model containment="true"
   * @generated
   */
  Expr getEx2();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Expr#getEx2 <em>Ex2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
