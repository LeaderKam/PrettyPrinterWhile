 ...
 * </p>
 * <ul>
 *   <li>{@link pretty.wh.Nop#getNop <em>Nop</em>}</li>
 * </ul>
 *
 * @see pretty.wh.WhPackage#getNop()
 * @model
 * @generated
 */
public interface Nop extends EObject
{
   ...
   * @see #setNop(String)
   * @see pretty.wh.WhPackage#getNop_Nop()
   * @model
   * @generated
   */
  String getNop();
  ...
  /**
   * Sets the value of the '{@link pretty.wh.Nop#getNop <em>Nop</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
