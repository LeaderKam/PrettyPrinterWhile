 ...
 * </p>
 * <ul>
 *   <li>{@link prettyCompilation.wh.Affectation#getAffectations <em>Affectations</em>}</li>
 *   <li>{@link prettyCompilation.wh.Affectation#getValeurs <em>Valeurs</em>}</li>
 * </ul>
 *
 * @see prettyCompilation.wh.WhPackage#getAffectation()
 * @model
 * @generated
 */
public interface Affectation extends EObject
{
   ...
   * @see prettyCompilation.wh.WhPackage#getAffectation_Affectations()
   * @model unique="false"
   * @generated
   */
   ...
   * @see prettyCompilation.wh.WhPackage#getAffectation_Valeurs()
