 ...
 * </p>
 * <ul>
 *   <li>{@link prettyCompilation.wh.impl.WriteImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WriteImpl extends MinimalEObjectImpl.Container implements Write
{
  ...
  {
    return WhPackage.Literals.WRITE;
  }
  ...
  public EList<String> getVariable()
  {
    if (variable == null)
    {
      variable = new EDataTypeEList<String>(String.class, this, WhPackage.WRITE__VARIABLE);
    }
    return variable;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WhPackage.WRITE__VARIABLE:
        return getVariable();
    }
