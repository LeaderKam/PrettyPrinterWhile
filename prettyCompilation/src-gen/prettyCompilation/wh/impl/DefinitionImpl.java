 ...
 * </p>
 * <ul>
 *   <li>{@link prettyCompilation.wh.impl.DefinitionImpl#getRead <em>Read</em>}</li>
 *   <li>{@link prettyCompilation.wh.impl.DefinitionImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link prettyCompilation.wh.impl.DefinitionImpl#getWrite <em>Write</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionImpl extends MinimalEObjectImpl.Container implements Definition
{
  ...
  public NotificationChain basicSetRead(Read newRead, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhPackage.DEFINITION__READ, oldRead, newRead);
  ...
  public void setRead(Read newRead)
  {
    if (newRead != read)
    {
      ...
      if (read != null)
        msgs = ((InternalEObject)read).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhPackage.DEFINITION__READ, null, msgs);
      if (newRead != null)
        msgs = ((InternalEObject)newRead).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhPackage.DEFINITION__READ, null, msgs);
      msgs = basicSetRead(newRead, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhPackage.DEFINITION__READ, newRead, newRead));
  }
  ...
  public NotificationChain basicSetWrite(Write newWrite, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhPackage.DEFINITION__WRITE, oldWrite, newWrite);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setWrite(Write newWrite)
  {
    if (newWrite != write)
    {
      NotificationChain msgs = null;
      if (write != null)
        msgs = ((InternalEObject)write).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhPackage.DEFINITION__WRITE, null, msgs);
      if (newWrite != null)
        msgs = ((InternalEObject)newWrite).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhPackage.DEFINITION__WRITE, null, msgs);
      msgs = basicSetWrite(newWrite, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhPackage.DEFINITION__WRITE, newWrite, newWrite));
  }
