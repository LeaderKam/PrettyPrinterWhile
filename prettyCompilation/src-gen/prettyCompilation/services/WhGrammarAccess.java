 ...
 */
package prettyCompilation.services;
...
public class WhGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Program");
	...
	public class FunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Function");
	...
	public class DefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Definition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ReadElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Read");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class WriteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Write");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AffectationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Affectation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NopElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Nop");
	...
	public class CommandsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Commands");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Command");
	...
	public class ForeachElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Foreach");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IfElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.If");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ForElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.For");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class WhileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.While");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Expr");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Assignment cSymbAssignment_2 = (Assignment)cAlternatives.eContents().get(2);
		private final RuleCall cSymbSYMBOLTerminalRuleCall_2_0 = (RuleCall)cSymbAssignment_2.eContents().get(0);
		...
		private final Keyword cOpeNotKeyword_8_1_0 = (Keyword)cOpeAssignment_8_1.eContents().get(0);
		...
		//valeur='nil' | valeur=VARIABLE | symb=SYMBOL | '(' ope='cons' lexpr=Lexpr ')' | '(' ope='list' lexpr=Lexpr ')' | '('
		//ope=SYMBOL lexpr=Lexpr ')' | '(' ope='hd' expr=Expr ')' | '(' ope='tl' expr=Expr ')' | '(' ope='not' expr=Expr ')' |
		//'(' ex1=Expr ope=('and' | 'or' | '=?') ex2=Expr ')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//symb=SYMBOL
		public Assignment getSymbAssignment_2() { return cSymbAssignment_2; }
		
		//SYMBOL
		public RuleCall getSymbSYMBOLTerminalRuleCall_2_0() { return cSymbSYMBOLTerminalRuleCall_2_0; }
		...
		//'not'
		public Keyword getOpeNotKeyword_8_1_0() { return cOpeNotKeyword_8_1_0; }
	...
	public class LexprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.Lexpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public WhGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tVARIABLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.VARIABLE");
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "prettyCompilation.Wh.SYMBOL");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("prettyCompilation.Wh".equals(grammar.getName())) {
				return grammar;
			}
